...
public abstract class IntervalTree<TKey extends Comparable<TKey>, TValue> {
  ...
  /**
   * Associates a given interval of keys with a certain value. Any previous association will be overwritten in the given
   * interval. <p> Overlapping intervals are not permitted. A key can only be associated with a single value.
   *
