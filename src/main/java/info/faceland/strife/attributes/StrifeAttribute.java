...
public enum StrifeAttribute {
    ...
    REGENERATION("Regeneration", ChatColor.BLUE, "How much health you recover per natural regeneration tick.", 1,
                 false),
    ...
    DAMAGE_REFLECT("Damage Reflect", ChatColor.BLUE, "Percentage of damage taken reflected back at your attacker.", 0,
                   true),
    MOVEMENT_SPEED("Movement Speed", ChatColor.BLUE, "Player's movement speed, base is 100, 200 is double.", 100,
                   false),
    ...
    ATTACK_SPEED("Attack Speed", ChatColor.YELLOW, "How quickly your melee damage recharges inbetween attacks", 2D,
                 true),
    ...
    CRITICAL_RATE("Critical Rate", ChatColor.YELLOW, "Chance of landing a critical strike, dealing bonus damage.", 0,
                  true),
    CRITICAL_DAMAGE("Critical Damage", ChatColor.YELLOW, "Percent damage you deal when you critically strike.", 1.25D,
                    true),
