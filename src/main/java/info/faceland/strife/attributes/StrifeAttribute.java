...
public enum StrifeAttribute {
    ...
    IGNITE_CHANCE("Ignite Chance", ChatColor.YELLOW, "Chance to ignite target on hit.", 0.1, true),
    SHOCK_CHANCE("Shock Chance", ChatColor.YELLOW, "Chance to shock target on hit.", 0.1, true),
    FREEZE_CHANCE("Freeze Chance", ChatColor.YELLOW, "Chance to freeze target on hit.", 0.1, true),
