...
public enum StrifeAttribute {
    ...
    RESISTANCE("Resistance", ChatColor.BLUE, "Reduces the probability of status effects.", 0, true),
    ...
    OVERCHARGE("Overcharge", ChatColor.YELLOW, "Bonus damage dealt when your attacks are fully recharged", 0.25, true),
