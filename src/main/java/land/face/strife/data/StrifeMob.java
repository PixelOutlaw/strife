...
public class StrifeMob {
  ...
  public void addMinion(StrifeMob minion, int lifespan, boolean thrall) {
    ...
    minion.forceSetStat(StrifeStat.ACCURACY, getStat(StrifeStat.ACCURACY));
    minion.forceSetStat(StrifeStat.PVP_ATTACK, getStat(StrifeStat.PVP_ATTACK));
    minion.forceSetStat(StrifeStat.PVP_DEFENCE, getStat(StrifeStat.PVP_DEFENCE));
