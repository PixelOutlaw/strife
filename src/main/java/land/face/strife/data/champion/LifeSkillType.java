...
public enum LifeSkillType {
  ...
  MINING("Mining", "mining", "\uD86D\uDF59", FaceColor.BROWN.getColor()),
  FARMING("Gathering", "farming", "\uD86D\uDF57", FaceColor.GREEN.getColor()),
  COOKING("Cooking", "cooking", "\uD86D\uDF59", FaceColor.TAN.getColor()),
  ALCHEMY("Alchemy", "alchemy", "\uD86D\uDF59", FaceColor.TEAL.getColor()),
  SNEAK("Sneak", "sneak", "\uD86D\uDF59", FaceColor.GRAY.getColor()),
  AGILITY("Agility", "agility", "\uD86D\uDF5D", FaceColor.TEAL.getColor()),
  TRADING("Trading", "trading", "\uD86D\uDF59", FaceColor.GREEN.getColor()),
  ...
  MARKSMANSHIP("Marksmanship", "marksmanship", "\uD86D\uDF5B", FaceColor.LIGHT_GRAY.getColor(), true),
