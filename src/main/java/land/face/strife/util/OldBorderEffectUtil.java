...
public class OldBorderEffectUtil {
  ...
  static {
    try {
      ...
      border_constructor = getClass("net.minecraft.world.level.border", "WorldBorder").getConstructor();
      ...
      center = getClass("net.minecraft.world.level.border", "WorldBorder")
          .getMethod(setCenter, double.class, double.class);
      distance = getClass("net.minecraft.world.level.border", "WorldBorder")
          .getMethod(setWarningDistance, int.class);
      time = getClass("net.minecraft.world.level.border", "WorldBorder").getMethod(setWarningTime, int.class);
      movement = getClass("net.minecraft.world.level.border", "WorldBorder")
